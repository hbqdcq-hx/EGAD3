...
def eval_det_loc(det_auroc_obs, loc_auroc_obs, loc_pro_obs, epoch, gt_label_list, anomaly_score, anomaly_score_map_add, anomaly_score_map_mul, pro_eval):
