...
from train_heatmap import train
...
def main(c):
    ...
    if c.dataset == 'mvtec':
        #c.data_path = '/mnt/T38/bioinf/xjj/Datasets/MVTec-AD'        #MVTec-AD/take-image/good_dataset
        c.data_path = '/mnt/T4_2/xjj/FirstWorkData1'
    elif c.dataset == 'stc':
