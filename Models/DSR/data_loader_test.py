...
class TestMVTecDataset(Dataset):
    ...
    def __init__(self, root_dir, resize_shape=None):
        ...
        self.images = sorted(glob.glob(root_dir + "/*/*.png") +  glob.glob(root_dir + "/*/*.jpg"))
    ...
    def __getitem__(self, idx):
        ...
        sample = {'image': image, 'has_anomaly': has_anomaly, 'idx': idx, 
                  'original_size': np.array([original_width, original_height], dtype=np.float32)}
