...
def train(item):
    ...
    for epoch in range(int(np.ceil(total_iters / len(train_dataloader)))):
        ...
        for img, label in train_dataloader:
            ...
            if (it + 1) % 5000 == 0:
                ...
                auroc_sp, ap_sp, f1_sp, auroc_px, ap_px, f1_px, aupro_px = results[:7]
    ...
    # 保存模型，添加类名到文件名
    model_save_path = os.path.join(args.save_dir, args.save_name, f'model_{item}.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/mnt/T38/bioinf/xjj/Datasets/MVTec-AD')
    ...
    item_list = [  'screw', 'toothbrush', 'transistor', 'zipper']
