...
def loading_dataset(c, dataset_name):
    ...
    if dataset_name == 'MVTec 3D-AD' and c.setting == 'oc':
        ...
        for i, item in enumerate(class_list):
            train_path = '/mnt/T38/bioinf/xjj/Datasets/{}/'.format(dataset_name) + item + '/train'
            test_path = '/mnt/T38/bioinf/xjj/Datasets/{}/'.format(dataset_name) + item
...
class MVTecDataset(torch.utils.data.Dataset):
    def __init__(self, c, is_train=False, dataset='FirstWorkData1'):
        self.dataset_path = '/mnt/T4_2/xjj/' + dataset          #/mnt/T38/bioinf/xjj/Datasets/MVTec-AD  /mnt/T4_2/xjj/FirstWorkData1  good_dataset
    ...
    def load_dataset(self):
        ...
        for defect_type in defect_types:
            if defect_type == 'good':
                ...
                img_paths = sorted(glob.glob(os.path.join(self.img_dir, defect_type) + "/*"))
